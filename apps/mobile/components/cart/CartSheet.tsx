...
//
// Phase 5: the university short-name/credit-cap self-serve edit fields that
// used to live here (with a comment admitting they weren't really "cart"
// content) moved to app/settings.tsx — this sheet is back to being just
